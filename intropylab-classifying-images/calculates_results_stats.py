...
def calculates_results_stats(results_dic):
    ...
    for k,v in results_dic.items():
        n_correct_dogs += 1 if v[3] == 1 and v[4] == 1 else 0
        n_dogs_img += 1 if v[3] == 1 else 0
        n_correct_notdogs += 1 if v[3] == 0 and v[4] == 0 else 0
        n_notdogs_img += 1 if v[3] == 0 else 0
        n_correct_breed += 1 if v[2] == 1 and v[3] == 1 else 0
        n_match += 1 if v[2] == 1 else 0
